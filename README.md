...
### 🛠 Tech Stack & Tools
* **Cloud Infrastructure:** AWS (EC2, S3, Lambda, SQS, RDS, IAM, VPC, CloudWatch, API Gateway, ECS/Fargate, DynamoDB, EventBridge)
* **DevOps & IaC:** Terraform, AWS CloudFormation, Docker, Kubernetes, Jenkins, GitHub Actions, Ansible
* **Programming & OS:** Python, Bash, Linux, Git
